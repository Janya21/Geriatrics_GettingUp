...
def extract_files(extenssion='mp4'):
        ...
        for vid_class in class_folders:
            ...
            for video_path in class_files:
                ...
                if not check_already_extracted(video_parts):
                    ...
                    dest = os.path.join("..","Images",train_or_test, classname,
    ...
    with open('../Images/data_file.csv', 'w') as fout:
...
def get_nb_frames_for_video(video_parts):
    ...
    generated_files = glob.glob(os.path.join("..","Images",train_or_test, classname,
                                filename_no_ext + '*.jpg'))
